...
class PendingDepositScreen extends StatefulWidget {
  const PendingDepositScreen({super.key});

  @override
  State<PendingDepositScreen> createState() => _PendingDepositScreenState();
}

class _PendingDepositScreenState extends State<PendingDepositScreen> {
          ...
          Padding(
            ...
            child: StreamBuilder(
              ...
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  print(snapshot.data!.docs.map((e) => e.data()['deposit']));
